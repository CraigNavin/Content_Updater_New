...
namespace Content_Updater
{
    class Program
    {
        ...
        public static void OnTimedEvent(object sender, ElapsedEventArgs e, List<String> urilist)
        {
            prodlist = checkforUpdates(prodlist, getAllproducts(urilist));
            insertData(prodlist);

        }
        
        public static  List<Product_table2> checkforUpdates(List<Product_table2> oldList, List<Product_table2> newList)
        {
        ...
        public static List<Product_table2> getAllproducts(List<string> urilist)
        {
        ...
        public static List<Product_table2> buildlistwcf(int listlen)
        {
        ...
        public static List<Product_table2> buildList(dynamic json, int listlen)
        {
            List<Product_table2> list = new List<Product_table2>();
            var result2 = JsonConvert.DeserializeObject<List<Product>>(json);
            foreach (Product x in result2)
            {
                Product_table2 prod = new Product_table2() { ID = x.ID + listlen,
                    Product_Name = x.Name,
        ...
        public static void insertData(List<Product_table2> list)
        {
            IProductRepository ProdRepo = new IProductRepository(new ProdDB());
        ...
        public static string ShowProduct(Product_table2 prod)
        {
            Console.WriteLine();
