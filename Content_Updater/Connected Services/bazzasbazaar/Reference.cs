...
namespace Content_Updater.bazzasbazaar {
    ...
    public interface IStore {
        ...
        Content_Updater.bazzasbazaar.Category[] GetAllCategories();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStore/GetAllCategories", ReplyAction="http://tempuri.org/IStore/GetAllCategoriesResponse")]
        System.Threading.Tasks.Task<Content_Updater.bazzasbazaar.Category[]> GetAllCategoriesAsync();
        ...
        Content_Updater.bazzasbazaar.Category GetCategoryById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStore/GetCategoryById", ReplyAction="http://tempuri.org/IStore/GetCategoryByIdResponse")]
        System.Threading.Tasks.Task<Content_Updater.bazzasbazaar.Category> GetCategoryByIdAsync(int id);
        ...
        Content_Updater.bazzasbazaar.Product[] GetFilteredProducts(System.Nullable<int> categoryId, string categoryName, System.Nullable<double> minPrice, System.Nullable<double> maxPrice);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStore/GetFilteredProducts", ReplyAction="http://tempuri.org/IStore/GetFilteredProductsResponse")]
        System.Threading.Tasks.Task<Content_Updater.bazzasbazaar.Product[]> GetFilteredProductsAsync(System.Nullable<int> categoryId, string categoryName, System.Nullable<double> minPrice, System.Nullable<double> maxPrice);
        ...
        Content_Updater.bazzasbazaar.Product GetProductById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStore/GetProductById", ReplyAction="http://tempuri.org/IStore/GetProductByIdResponse")]
        System.Threading.Tasks.Task<Content_Updater.bazzasbazaar.Product> GetProductByIdAsync(int id);
        ...
        Content_Updater.bazzasbazaar.Order GetOrderById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStore/GetOrderById", ReplyAction="http://tempuri.org/IStore/GetOrderByIdResponse")]
        System.Threading.Tasks.Task<Content_Updater.bazzasbazaar.Order> GetOrderByIdAsync(int id);
        ...
        Content_Updater.bazzasbazaar.Order CreateOrder(string accountName, string cardNumber, int productId, int quantity);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStore/CreateOrder", ReplyAction="http://tempuri.org/IStore/CreateOrderResponse")]
        System.Threading.Tasks.Task<Content_Updater.bazzasbazaar.Order> CreateOrderAsync(string accountName, string cardNumber, int productId, int quantity);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IStoreChannel : Content_Updater.bazzasbazaar.IStore, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class StoreClient : System.ServiceModel.ClientBase<Content_Updater.bazzasbazaar.IStore>, Content_Updater.bazzasbazaar.IStore {
        ...
        public Content_Updater.bazzasbazaar.Category[] GetAllCategories() {
            return base.Channel.GetAllCategories();
        }
        
        public System.Threading.Tasks.Task<Content_Updater.bazzasbazaar.Category[]> GetAllCategoriesAsync() {
            return base.Channel.GetAllCategoriesAsync();
        }
        
        public Content_Updater.bazzasbazaar.Category GetCategoryById(int id) {
            return base.Channel.GetCategoryById(id);
        }
        
        public System.Threading.Tasks.Task<Content_Updater.bazzasbazaar.Category> GetCategoryByIdAsync(int id) {
            return base.Channel.GetCategoryByIdAsync(id);
        }
        
        public Content_Updater.bazzasbazaar.Product[] GetFilteredProducts(System.Nullable<int> categoryId, string categoryName, System.Nullable<double> minPrice, System.Nullable<double> maxPrice) {
            return base.Channel.GetFilteredProducts(categoryId, categoryName, minPrice, maxPrice);
        }
        
        public System.Threading.Tasks.Task<Content_Updater.bazzasbazaar.Product[]> GetFilteredProductsAsync(System.Nullable<int> categoryId, string categoryName, System.Nullable<double> minPrice, System.Nullable<double> maxPrice) {
            return base.Channel.GetFilteredProductsAsync(categoryId, categoryName, minPrice, maxPrice);
        }
        
        public Content_Updater.bazzasbazaar.Product GetProductById(int id) {
            return base.Channel.GetProductById(id);
        }
        
        public System.Threading.Tasks.Task<Content_Updater.bazzasbazaar.Product> GetProductByIdAsync(int id) {
            return base.Channel.GetProductByIdAsync(id);
        }
        
        public Content_Updater.bazzasbazaar.Order GetOrderById(int id) {
            return base.Channel.GetOrderById(id);
        }
        
        public System.Threading.Tasks.Task<Content_Updater.bazzasbazaar.Order> GetOrderByIdAsync(int id) {
            return base.Channel.GetOrderByIdAsync(id);
        }
        
        public Content_Updater.bazzasbazaar.Order CreateOrder(string accountName, string cardNumber, int productId, int quantity) {
            return base.Channel.CreateOrder(accountName, cardNumber, productId, quantity);
        }
        
        public System.Threading.Tasks.Task<Content_Updater.bazzasbazaar.Order> CreateOrderAsync(string accountName, string cardNumber, int productId, int quantity) {
